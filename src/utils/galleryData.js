/**
 * Gallery data organized by gallery ID
 * Each gallery contains an array of image objects with src and alt properties
 */
export const galleryData = {
    ...
    'Gd465vD': [{ src: 'i-Gd465vD', alt: 'Frente do Pateo' }],
    'R6VhpZP': [{ src: 'i-R6VhpZP', alt: 'Frente do Pateo' }],
    '86P4hVV': [{ src: 'i-86P4hVV', alt: 'Frente do Pateo' }],
    'KJPJ8s3': [{ src: 'i-KJPJ8s3', alt: 'Frente do Pateo' }],
    'nTV6p53': [{ src: 'i-nTV6p53', alt: 'Frente do Pateo' }],
    'struture-placagem': [
    ...
    'xZsHz3H': [{ src: 'i-xZsHz3H', alt: 'Frente do Pateo' }],
    'kpZhqFK': [{ src: 'i-kpZhqFK', alt: 'Frente do Pateo' }],
    'C2hpQ22': [{ src: 'i-C2hpQ22', alt: 'Frente do Pateo' }],
    'qtBN7Th': [{ src: 'i-qtBN7Th', alt: 'Frente do Pateo' }],
    'Nx97FRX': [{ src: 'i-Nx97FRX', alt: 'Frente do Pateo' }],
    'VxqTwBp': [
    ...
    'Ljxqq56': [{ src: 'i-kXRJ5PP', alt: 'Frente do Pateo' }],
    'CNdnk4N': [{ src: 'i-CbJcbG2CNdnk4N', alt: 'Frente do Pateo' }],
    'j5tP9DS': [
    ...
    'VDCxhNV': [{ src: 'i-VDCxhNV', alt: 'Frente do Pateo' }],
    'VdPhXpK': [{ src: 'i-VdPhXpK', alt: 'Frente do Pateo' }],
    'b57PzZJ': [{ src: 'i-b57PzZJ', alt: 'Frente do Pateo' }],
    'J9xqwTx': [{ src: 'i-J9xqwTx', alt: 'Frente do Pateo' }],
    '6NSSZ3D': [{ src: 'i-6NSSZ3D', alt: 'Frente do Pateo' }],
    'QzJ77SX': [{ src: 'i-QzJ77SX', alt: 'Frente do Pateo' }],
    'fPCZT7m': [{ src: 'i-fPCZT7m', alt: 'Frente do Pateo' }],
    'exterior06': [
    ...
    'rwXDH3C': [{ src: 'i-rwXDH3C', alt: 'Frente do Pateo' }],
    'Xb7drm4': [{ src: 'i-Xb7drm4', alt: 'Frente do Pateo' }],
    'vdsPGSb': [{ src: 'i-vdsPGSb', alt: 'Frente do Pateo' }],
    'KLzbJdP': [
        { src: 'i-FL3m5jn', alt: 'Frente do Pateo' },
        { src: 'i-KLzbJdP', alt: 'Frente do Pateo' }
    ],
    'm2Z2VZ3': [{ src: 'i-m2Z2VZ3', alt: 'Frente do Pateo' }],
    'MKcpsDx': [{ src: 'i-MKcpsDx', alt: 'Frente do Pateo' }],
    'bb8vnFH': [{ src: 'i-bb8vnFH', alt: 'Frente do Pateo' }],
    'kZbR4b7': [{ src: 'i-kZbR4b7', alt: 'Frente do Pateo' }],
    'zGfrntx': [{ src: 'i-zGfrntx', alt: 'Frente do Pateo' }],
    'rtNBkvR': [{ src: 'i-rtNBkvR', alt: 'Frente do Pateo' }],
    'jXzfknQ': [{ src: 'i-jXzfknQ', alt: 'Frente do Pateo' }],
    'p5HrmN9': [{ src: 'i-p5HrmN9', alt: 'Frente do Pateo' }],
    'Bq4D797': [{ src: 'i-Bq4D797', alt: 'Frente do Pateo' }],
    'jVGF5Wv': [{ src: 'i-jVGF5Wv', alt: 'Frente do Pateo' }],
    'cjxZhrS': [{ src: 'i-cjxZhrS', alt: 'Frente do Pateo' }],
    'Q4vZN8k': [{ src: 'i-Q4vZN8k', alt: 'Frente do Pateo' }],
    'Pnbg7tQ': [{ src: 'i-Pnbg7tQ', alt: 'Frente do Pateo' }],
    's4b4qHC': [{ src: 'i-s4b4qHC', alt: 'Frente do Pateo' }],
    'XDZSncQ': [{ src: 'i-XDZSncQ', alt: 'Frente do Pateo' }],
...
/**
 * Function to get gallery images by ID
 * @param {string} galleryId - The gallery identifier
 * @returns {Array} - Array of image objects or empty array if gallery not found
 */
export function getGalleryImages(galleryId) {
    return galleryData[galleryId] || [];
}
