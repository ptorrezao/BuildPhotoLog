...
const customIcons = {
    'lamp': L.icon({ iconUrl: process.env.BASE_URL + "icons/lamp.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 41], popupAnchor: [0, -41] }),
    'pool': L.icon({ iconUrl:  process.env.BASE_URL + "icons/filter.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 41], popupAnchor: [0, -41] }),
    'pipe': L.icon({ iconUrl:  process.env.BASE_URL + "icons/water-pipe.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 41], popupAnchor: [0, -41] }),
    'well': L.icon({ iconUrl:  process.env.BASE_URL + "icons/rain-water-harvesting.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 41], popupAnchor: [0, -41] }),
    'sewage': L.icon({ iconUrl:  process.env.BASE_URL + "icons/tee.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 36], popupAnchor: [0, -36] }),
    'water': L.icon({ iconUrl:  process.env.BASE_URL + "icons/tap.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 36], popupAnchor: [0, -36] }),
    'electric': L.icon({ iconUrl:  process.env.BASE_URL + "icons/wire.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 36], popupAnchor: [0, -36] }),
    'telcom': L.icon({ iconUrl:  process.env.BASE_URL + "icons/lan.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 36], popupAnchor: [0, -36] }),
    'gallery': L.icon({ iconUrl:  process.env.BASE_URL + "icons/camera.png", shadowUrl: iconShadow, iconSize: liconSize, iconAnchor: [12, 42], popupAnchor: [0, -42] }),
};
...
export default {
    ...
    props: {
        ...
        imageUrl: {
            type: String,
            default:  process.env.BASE_URL + 'images/DJI_0784.jpg'
        },
        showGalery: {
            type: Boolean,
            default: true
    ...
    methods: {
        ...
        updateImageOverlay(imgWidth, imgHeight) {
            ...
            if (this.showFloorPlant) {
                ...
                L.imageOverlay(process.env.BASE_URL + 'images/20240101.jpg', bounds, { opacity: 0.5 }).addTo(this.map);
            }
